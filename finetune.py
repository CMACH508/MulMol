...
def finetune(args):
    ...
    model.predictor = get_predictor(d_input_feats=config['d_g_feats']*4, n_tasks=train_dataset.n_tasks, n_layers=4, predictor_drop=args.dropout, device=device, d_hidden_feats=256)
    del model.md_predictor
    del model.fp_predictor
    del model.cf_predictor
